...
public class TireToWheel : MonoBehaviour {
	...
	void UpdateWheelHeight(Transform wheelTransform, WheelCollider collider) 
	{
		...
		{		
			...
			localPosition = Vector3.Lerp (localPosition, -Vector3.up * collider.suspensionDistance, 0.05f);
		...
		wheelTransform.localRotation = Quaternion.Euler(collider.motorTorque, collider.steerAngle, 0f);
