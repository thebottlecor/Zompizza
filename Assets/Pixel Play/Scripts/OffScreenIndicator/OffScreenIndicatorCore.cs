...
namespace PixelPlay.OffScreenIndicator
{
    public class OffScreenIndicatorCore
    {
        ...
        /// <returns></returns>
        public static bool IsTargetVisible(Camera mainCamera, Vector3 targetPosition)
        {
            Vector2 vec = mainCamera.WorldToViewportPoint(targetPosition);
        ...
        //public static bool IsTargetVisible(Camera mainCamera, Vector3 screenPosition)
        //{
